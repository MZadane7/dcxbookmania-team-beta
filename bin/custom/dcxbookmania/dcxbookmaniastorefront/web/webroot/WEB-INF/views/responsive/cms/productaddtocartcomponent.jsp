...
<div class="addtocart-component">
		...
		<div class="qty-selector input-group js-qty-selector">
			<span class="input-group-btn" style=color:FAE8E0>
				<button class="btn btn-default js-qty-selector-minus" type="button" <c:if test="${qtyMinus <= 1}"><c:out value="disabled='disabled'"/></c:if> ><span class="glyphicon glyphicon-chevron-down" aria-hidden="true" ></span></button>
			</span>
			...
			<span class="input-group-btn">
				<button class="btn btn-default js-qty-selector-plus" type="button"><span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span></button>
			</span>
		</div>
		</c:if>
